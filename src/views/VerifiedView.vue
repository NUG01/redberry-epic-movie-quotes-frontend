...
export default {
  name:"Verified",
  components:{FormHeader,LoginForm, BasicButton, VerifiedTick},
  setup(){
...
<template>
    ...
    <div class="fixed mob:w-[100%] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center px-[9rem] py-[6rem] bg-[#222030] rounded-[10px] z-50">
      <verified-tick></verified-tick>
      <div class="flex flex-col text-center gap-[3rem] mb-[3rem] mt-[4rem]">
