...
<div class="fixed top-0 left-0 h-[100%] w-[100%] z-30">
  <header class="absolute top-0 left-0 w-[100%] h-[auto] py-[3rem] px-[5rem] flex items-center justify-between z-50">
    ...
    <div class="flex gap-[1.6rem]">
      ...
      <router-link :to="{name:'registration'}"><basic-button text="text-[1.6rem]" class="text-[1.6rem] text-[#ffffff]" type="button" paddings="px-[25.5px] py-[7px]" rounded="rounded-[4px]">{{ $t('landing.signup') }}</basic-button></router-link>
