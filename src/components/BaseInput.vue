<template>
  ...
  <div class="flex flex-col w-[100%] mb-[1.6rem] relative">
    ...
    <div class="relative">
    <Field @blur="stateChange" :value="val" :rules="rules" :type="inputType" :name="inputName" :id="inputName" :placeholder="inputText" 
...
export default {
  ...
  components:{Field, ErrorMessage, PasswordHidden,InvalidIcon,ValidIcon},
  setup(props,context){
    ...
    return {inputName,inputType,inputText,label,rules,val,stateChange,noState,validState};
  }
}
</script>
